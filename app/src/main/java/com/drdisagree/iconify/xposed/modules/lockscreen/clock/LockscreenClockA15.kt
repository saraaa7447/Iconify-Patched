...
import com.drdisagree.iconify.xposed.modules.utils.ViewHelper.assignIdsToViews
...
import com.drdisagree.iconify.xposed.modules.utils.ViewHelper.getLsItemsContainer
import com.drdisagree.iconify.xposed.modules.utils.ViewHelper.hideView
import com.drdisagree.iconify.xposed.modules.utils.ViewHelper.reAddView
...
import com.drdisagree.iconify.xposed.modules.utils.LockscreenUtils.isComposeLockscreen
            ...
            when (clockStyle) {
                2, 20 -> {
                    val tickIndicator = findViewContainsTag("tickIndicator") as? TextClock
                        ?: return@apply
                    val hourView = findViewContainsTag("hours") as? TextView ?: return@apply
